...
public class SkillCacheRefresher {
    ...
    public void refreshCache() {
        ...
        try {
            // 获取所有本地缓存的技能 ID
            Map<String, SkillCache.CacheEntry> cacheMap = skillCache.getCache();
            ...
            // 遍历本地缓存，检查时间戳
            for (Map.Entry<String, SkillCache.CacheEntry> entry : cacheMap.entrySet()) {
     ...
     * 刷新单个技能
     */
    private void refreshSkill(String skillId) {
        try {
            // 从服务端获取最新技能信息
     ...
     * 从服务端获取技能时间戳
     */
    private Long getSkillTimestampFromServer(String skillId) {
        try {
